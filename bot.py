...
def menu(message):
    if message.text == '/menu':
        bot.send_message(message.chat.id, f'Выберите пункт меню, введя команду: \n/1 - Добавить новую позицию.\n'
        ...
        bot.send_message(message.chat.id, f'Я Вас не понимаю. Повторите ввод или введите: /help.')
...
def send_txt(message):
    ...
    bot.send_message(message.chat.id, text=f'Файл отправлен!\nВведите /menu для возврата в меню')
